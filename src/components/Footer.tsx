...
const Footer: React.FC = () => {
  return (
      ...
      {/* <div
  id="FOOTERRoot"
  className="overflow-hidden bg-[#1086a0] flex flex-col gap-8 
  w-full h-[496px] py-4"
>
  <div className="flex flex-row gap-20 items-center mb-5 ml-24 mr-64">
    <div className="self-start flex flex-col gap-3 items-start">
      <img
        src="https://file.rendit.io/n/1A6r6dlt4CsOXWJ1Baem.png"
        id="Logo"
        className=""
      />
      <div className="text-lg font-['Open_Sans'] leading-[32px] 
      text-[#f1f1f1] ml-1 w-full">
        Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas
        porttitor congue massa. Fusce posuere, magna sed pulvinar
        ultricies,{" "}
      </div>
    </div>
    <div className="relative flex flex-col mr-5 pb-16 w-40 shrink-0 
    items-start">
      <div
        id="AboutUsContactUs1"
        className="text-xl font-['Calibri'] leading-[16.5px] 
        text-white absolute top-5 left-0 h-20 w-full"
      >
        About Us
        <br />
        <br />
      ...
      <div className="text-xl font-['Abhaya_Libre'] font-bold 
      leading-[32px] text-white relative w-full">
        Reach Us
      </div>
    </div>
  ...
  <div className="self-center flex flex-row justify-between gap-8 items-start">
    <img
      src="https://file.rendit.io/n/MeYOopg6lVLT5tn65Bj2.svg"
      id="Icbaselinefacebook"
      className="w-10 shrink-0"
    />
    <img
      src="https://file.rendit.io/n/nt2HLk6TgJUDueeAMuK4.svg"
      id="Mdiinstagram"
      className="w-12 shrink-0"
    />
    <img
      src="https://file.rendit.io/n/8RacahfrmoS10uwUJnH5.svg"
      id="Mditwitter"
      className="w-10 shrink-0"
    />
    <img
      src="https://file.rendit.io/n/SgKBYuEZqPp9n2X21PYt.svg"
      id="Biyoutube"
    ...
    />
      ...
      <div className="flex flex-col  w-full h-[496px] ">
        <div className=' flex flex-row gap-20 items-center mb-5 ml-24 mr-64'>
          ...
          <div className='self-start flex flex-col gap-3 items-start'>
            ...
            <img src='../KGFlogo.svg' className='w-[136px] h-[144px] object-contain' />
              <div className='w-full leading-[32px] ml-1'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Maecenas
            porttitor congue massa. Fusce posuere, magna sed pulvinar
            ultricies,
            </div>
          </div>

          <div className=' relative flex flex-col mr-5 w-40 
          shrink-0 items-start'>
            <div className="absolute w-full top-5 left-0 h-20 text-xl font-['Calibri']">
              About Us <br /> 
              Contact Us <br /> 
            </div>
            
          <div className="relative w-full text-xl 
          font-['Abhaya_Libre'] font-bold ">Reach Us</div>
          </div>
          ...
          shrink-0 items-start'>
            ...
            <div className='relative w-full'>Programs</div>
          </div>
          ...
          shrink-0 items-start'>
            ...
            <div className='relative w-full'>Resource</div>
          </div>
        </div>
      ...
      <div className="border-t pt-4 flex flex-row justify-center gap-8 items-center">          
              ...
              <a href="#" className="hover:text-gray-900 dark:hover:text-white">
                  <svg className="w-10 h-10 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
              ...
              <a href="#" className="hover:text-gray-900 dark:hover:text-white">
                  <svg className="w-10 h-10 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 17">
                    <path fill-rule="evenodd" d="M20 1.892a8.178 8.178 0 0 1-2.355.635 4.074 4.074 0 0 0 1.8-2.235 8.344 8.344 0 0 1-2.605.98A4.13 4.13 0 0 0 13.85 0a4.068 4.068 0 0 0-4.1 4.038 4 4 0 0 0 .105.919A11.705 11.705 0 0 1 1.4.734a4.006 4.006 0 0 0 1.268 5.392 4.165 4.165 0 0 1-1.859-.5v.05A4.057 4.057 0 0 0 4.1 9.635a4.19 4.19 0 0 1-1.856.07 4.108 4.108 0 0 0 3.831 2.807A8.36 8.36 0 0 1 0 14.184 11.732 11.732 0 0 0 6.291 16 11.502 11.502 0 0 0 17.964 4.5c0-.177 0-.35-.012-.523A8.143 8.143 0 0 0 20 1.892Z" clip-rule="evenodd"/>
                </svg>
                  <span className="sr-only">Twitter page</span>
              </a>
              <a href="#" className="hover:text-gray-900 dark:hover:text-white">
                  <svg className="w-10 h-10 shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
